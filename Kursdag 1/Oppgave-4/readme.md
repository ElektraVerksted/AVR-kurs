...
Hint: Etter dere har konfigurert MCC og generert filer kan dere finne alle tilgjengelige funksjoner under _\<prosjektmappe>/MY_MCC_Config/mcc_generated_files/system_. For denne oppgaven er funksjonene i headerfilen 

"pins.h" filen er relevant.
