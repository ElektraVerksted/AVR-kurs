...
void oppdaterSkjerm() {
  ...
  /*
   * Starter med tomme strings. Vi har tre mellomrom slik at om vi ikke viser
   * "SWn" vil de andre strengene ha samme posisjon. Merk at det er fire
   * elementer i listen. Det er fordi vi må ha plass til en  "terminerende
   * karakter", en byte som skrives på slutten av en string
   */
  char SW1[4] = "   ";
  char SW2[4] = "   ";
  char SW3[4] = "   ";
  ...
  /*
   * Om bryteren er trykket bytter vi ut verdien i variablen med "SWn ". Merk at
   * vi må bruke funksjonen strcpy(), eller string-copy. Det er fordi strings i
   * C egentlig er en liste med enkeltkarakterer(char), så vi må bruke en
